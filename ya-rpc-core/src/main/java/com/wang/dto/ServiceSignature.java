 ...
 * RPC 服务的签名
 * @author happytsing
 * 重写 equals 和 hashcode 参考: https://www.cnblogs.com/myseries/p/10977868.html
 * Set 去重操作时，会先判断两个 hashCode 是否相同，在使用 equals 判断是否相同。
 * 因此，再重写 equals 时，必须重写 hashCode。
 * 而 equals 是必须重写的，因为其原本的实现非常粗糙。
 */
@Getter
@AllArgsConstructor
public class ServiceSignature {
    ...
    /**
     * 根据 jdk 给出的构造 hashCode 的方法进行书写，可参考 https://www.cnblogs.com/myseries/p/10977868.html
     */
    @Override
    public int hashCode() {
        int result = 17;
